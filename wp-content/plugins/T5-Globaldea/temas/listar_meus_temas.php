...
<div class="container-fluid">
    <div class="row">
        <div class="text-title-posts-list">
                <h2 class="text-center">Listar os Meus Temas</h2>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="" method="get">
                <input type="hidden" name="page" value="listar-meus-temas" >
        ...
        <div class="col-md-12">
            <?php if ( $query->have_posts() ): ?>
                                ...
                                <tr id="act_tema_id_<?php echo $post->ID; ?>">
                                                ...
                                                success: function (response) {
                                                    ...
                                                    var x = setInterval(function() {
                                                        ...
                                                        if (distance <= 0) {
                                                            ...
                                                            jQuery("#actions_list_temas_"+post_tema_id).html('<button type="button" class="btn btn-primary" id="botao_assumir_tema_'+post_tema_id+'" onclick="assumirTema('+user_id+','+post_tema_id+','+p_til+');">Primary 2</button>');

                                                            // Remover post_id

                                                            //console.log(response.data.post_id, response.data.tema_id);
                                    ...
                                    if ($values[0] != 0)
                                    {
                                        ...
                                        if (!in_array("administrator", $user_roles)) {
                                            ...
                                            if ($author_id == get_current_user_id() && ($st === 'pending' || $st === 'publish') && $current_status === 'publish')
                                            {
                                                $a = '1';
                                            ...
                                            } else if ($author_id != get_current_user_id() && ($st === 'pending' || $st === 'publish') && $current_status === 'publish')
                                            {
                                                $a = '0';
                                                $enabled = 'disabled';
                                            ...
                                            else if(!($st === 'pending') && !($st === 'publish') && $current_status === 'publish')
                                            {
                                                ...
                                                if($horaspub_article_vis >= $actual_data_article)
                                                {
                                                    ...
                                                    $url = admin_url( 'admin.php?page=atribuir-tema-novo-artigo&user_id='.$author_id.'&post_tema_id='.$post->ID.'&post_tile_tema='.$post->post_title );
                                                    ...
                                                    <script>
                                                        ...
                                                        jQuery("#act_tema_id_"+p_tema_iden).each(function () {
                                                            ...
                                                            var t = setInterval(function() {
                                                                ...
                                                                urlGetTemas(ij, pos_title_ij, user_id, curr_id, 'atribuir-tema-novo-artigo');
                                    ...
                                    <td id="actions_list_temas_<?php echo $post->ID; ?>">
                                        ...
                                        if ($a == 1 || $a == 10)
                                        {
                                            ?>
                                                ...
                                                <a href="admin.php?page=editar-artigo-tema&post_id=<?php echo $values[0]; ?>&tema_id=<?php echo $post->ID; ?>" type="button" class="btn btn-primary" id="botao_assumir_tema_<?php echo $post->ID?>" title="Editar Artigo <?php echo $values[0]; ?>"><i class="fa fa-pencil-square" aria-hidden="true"></i> Editar Artigo <?php echo $values[0]; ?></a>
                                        ...
                                        {
                                            ?>
                                            <a href="admin.php?page=editar-artigo-tema&post_id=<?php echo $values[0]; ?>&tema_id=<?php echo $post->ID; ?>" type="button" class="btn btn-primary disabled" id="botao_assumir_tema_<?php echo $post->ID?>" <?php echo $enabled ?> title="Editar Artigo <?php echo $values[0]; ?>"><i class="fa fa-pencil-square" aria-hidden="true"></i> Editar Artigo <?php echo $values[0]; ?></a>
                                            <?php
                                        }
                ...
                if($post_count > $posts_per_page ){
                    ...
                    if($paged > 1){
                        echo '<li><a class="first" href="?page=listar-meus-temas&paged=1&s='.$_GET['s'].'&lines='.$_GET['lines'].'">&laquo;</a></li>';
                    }else{
                    ...
                    for($p = 1; $p <= $num_pages; $p++){
                        if ($paged == $p) {
                            ...
                            echo '<li><a href="?page=listar-meus-temas&paged='.$p.'&s='.$_GET['s'].'&lines='.$_GET['lines'].'">'.$p.'</a></li>';
                        }
                    }

                    if($paged < $num_pages){
                        echo '<li><a class="last" href="?page=listar-meus-temas&paged='.$num_pages.'&s='.$_GET['s'].'&lines='.$_GET['lines'].'">&raquo;</a></li>';
                    }else{
